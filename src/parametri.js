...
export const FONTI = {
  ...
  apprendistato: {
    livello: 1,
    statoVerifica: 'atto-letto',
    dove: 'INPS, circolare n. 108 del 14/11/2018 — “Apprendistato: riepilogo degli obblighi contributivi”, per l’aliquota a carico dell’apprendista, la sua durata, e se valgano massimale e aliquota aggiuntiva dell’1%',
    canale: 'inps',
    lacuna:
      'la disciplina del contratto è letta sul D.Lgs. 81/2015; l’aliquota contributiva a ' +
      'carico dell’apprendista no. Non sta in quel decreto né nell’art. 1 c. 773 della ' +
      'L. 296/2006, che pure le fonti secondarie indicano concordemente e che è stato letto: ' +
      'quel comma riguarda la sola quota del datore. Senza l’aliquota il tipo di contratto ' +
      'resta disattivato nel modulo, e il motore si ferma invece di usare quella ordinaria',
...
export const PARAMETRI_2026 = {
  ...
  fuoriPerimetro: [
    ...
    },
    {
      ...
      norma: 'Art. 1 c. 773 della L. 296/2006, letto in originale',
      motivo:
        'Il datore versa il 10% della retribuzione imponibile, ridotto di 8,5 punti nel primo ' +
        'anno di contratto e di 7 nel secondo per chi occupa fino a nove addetti, con ritorno ' +
