...
export const FONTI = {
  ...
  detrazioneLavoro: {
    ...
    url:
      'https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:decreto.del.presidente.della.repubblica:1986-12-22;917',
    verifica:
      'PARZIALE. Lo schema del comma 1 è stato confrontato riga per riga con le formule del ' +
      'motore sul testo della circolare 4/E/2025, e da lì è emerso che il minimo era applicato ' +
      'a tutte le fasce anziché alla sola lettera a) — corretto, con test di regressione. La ' +
      'MAGGIORAZIONE DI 65 € del comma 1.1 non compare invece in quella circolare: importo e ' +
      'fascia 25.000-35.000 poggiano su fonti secondarie convergenti, non su una lettura ' +
      'diretta del testo. Da verificare su Normattiva prima di qualunque uso non dimostrativo: ' +
      'è il valore su cui il modello diverge da un calcolatore esterno (metodologia §3.4)',
  },
