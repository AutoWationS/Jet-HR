...
export const FONTI = {
  ...
  ragguaglioGiorni: {
    livello: 2,
    statoVerifica: 'atto-letto',
    dove: 'Circolare 326/E/1997, letta per intero; istruzioni al modello 730/2026, rigo C5, lette per le due regole del conteggio',
    canale: 'def',
    ...
    norma:
      ...
      'paga) e par. 3.4 (effettuazione della ritenuta); istruzioni al modello 730/2026, ' +
      'rigo C5 del quadro C, per il conteggio dei giorni',
    dettaglio:
      'L’anno va sempre assunto di 365 giorni, anche se bisestile. Nel conteggio vanno in ogni ' +
      'caso compresi le festività, i riposi settimanali e gli altri giorni non lavorativi; ' +
      'vanno sottratti i giorni per cui non spetta alcuna retribuzione, neanche differita. In ' +
      'caso di più rapporti, i giorni dei periodi contemporanei si contano una volta sola.',
    ...
    verifica:
      ...
      'accessorie NON stanno in questa circolare: la loro sede è nelle istruzioni ai modelli ' +
      'dichiarativi. LE ISTRUZIONI SONO STATE POI APERTE — modello 730/2026, agg. 28/05/2026, ' +
      'rigo C5 “Periodo di lavoro”, pagg. 41-42, lette sulle pagine trasmesse dal ' +
      'committente — e contengono entrambe le regole alla lettera: i giorni si determinano ' +
      '“tenendo conto che vanno in ogni caso compresi le festività, i riposi settimanali e ' +
      'gli altri giorni non lavorativi e che vanno sottratti i giorni per cui non spetta ' +
      'alcuna retribuzione, neanche differita (ad esempio, in caso di assenza per aspettativa ' +
      'senza corresponsione di assegni)”, e con più redditi di lavoro dipendente va indicato ' +
      'il totale “tenendo conto che quelli compresi in periodi contemporanei devono essere ' +
      'considerati una volta sola” — regola ripetuta per la colonna della pensione e per il ' +
      'tetto complessivo dei 365. Un dettaglio di collocazione va detto: la regola del ' +
      'conteggio sta nel punto dedicato a chi non ha una Certificazione Unica, cioè a chi i ' +
      'giorni deve contarli da sé — che è esattamente ciò che fa il motore. E una conferma ' +
      'non cercata: nel part-time “i giorni possono essere considerati per l’intero periodo ' +
      'di lavoro”. La fonte non ha più lacune',
  },
};
  ...
  fuoriPerimetro: [
    {
      ...
      norma:
        'Art. 16-ter TUIR, introdotto dall’art. 1 c. 10 della L. 207/2024 e letto in ' +
        'originale sul testo vigente 2026, compreso il c. 5-bis inserito dall’art. 1 c. 4 ' +
        'della L. 199/2025 (440 € oltre 200.000); art. 2 del D.Lgs. 216/2023, letto in ' +
        'originale (260 €, per il solo anno 2024)',
      motivo:
        ...
        'premi e rate di spese ante 2025. I 260 € oltre 50.000 che guide e riassunti ' +
        'affiancano ancora ai 440 stanno nell’art. 2 del D.Lgs. 216/2023, e il testo letto ' +
        'in originale li limita «per l’anno 2024»: nel 2026 non esistono più. Tutto inerte ' +
        'finché il modello non rappresenta oneri detraibili, e per la stessa ragione ' +
        'dichiarato e non applicato.',
    },
    {
      voce: 'Oneri detraibili dell’art. 15: mutuo, spese sanitarie, istruzione',
      norma: 'Artt. 15, 16 e 16-bis TUIR',
      motivo:
        'Il modello accetta oneri DEDUCIBILI, che riducono il reddito (art. 10), ma nessun ' +
        'onere DETRAIBILE, che riduce l’imposta: spese sanitarie oltre la franchigia di ' +
        '129,11 €, interessi del mutuo sull’abitazione principale, spese di istruzione, ' +
        'premi assicurativi, canoni di locazione (art. 16), rate dei recuperi edilizi ' +
        '(art. 16-bis). Ogni voce ha massimale e condizioni proprie, che un campo unico ' +
        'appiattirebbe; ed è la loro assenza a rendere inerti — quindi dichiarate e non ' +
        'applicate — le riduzioni della voce precedente. Per chi le ha, il netto vero è ' +
        'più alto di quello mostrato: la detrazione arriva in dichiarazione, non nella ' +
        'proiezione di una RAL.',
    },
    {
      voce: 'TFR',
      norma:
        'Art. 2120 c.c.; artt. 2 e 3 della L. 297/1982, letti in originale; art. 12 c. 4 ' +
        'lett. a) della L. 153/1969',
      motivo:
        'Accantonato e non erogato: circa il 7,41% della retribuzione utile (1/13,5) al ' +
        'netto della rivalsa dello 0,50% — due aumenti dell’aliquota IVS a carico del ' +
        'DATORE, 0,30 punti dal luglio 1982 e 0,20 dal gennaio 1983, che l’ultimo comma ' +
        'dell’art. 3 fa detrarre «dall’ammontare della quota del trattamento di fine ' +
        'rapporto». Il Fondo di garanzia dell’art. 2, che paga il TFR se il datore è ' +
        'insolvente, è invece alimentato da un contributo del solo datore — nella legge ' +
        '0,03%, rivedibile per decreto — senza rivalsa. Non transita nella retribuzione ' +
        'corrente, quindi non entra nel netto in busta paga. È fuori anche dalla base ' +
        'contributiva, che lo esclude espressamente: “sono esclusi dalla base imponibile ' +
    ...
    {
      voce: 'Regimi che abbattono l’imponibile: impatriati, ricercatori, frontalieri',
      norma:
        'Art. 5 del D.Lgs. 209/2023 e art. 44 del D.L. 78/2010, letti in originale sul ' +
        'testo vigente; art. 1 c. 175 della L. 147/2013 e art. 4 della L. 83/2023, letti ' +
        'in originale: il secondo fissa a 10.000 € la franchigia del primo',
      motivo:
        'Tre regimi personali riducono il reddito imponibile a monte dell’intera catena. ' +
        'Chi trasferisce la residenza fiscale in Italia dal 2024 nei requisiti dell’art. 5 ' +
        'conta il reddito di lavoro al 50% — al 40% con un figlio minore — entro 600.000 € ' +
        'l’anno, per cinque periodi d’imposta, con decadenza e recupero se la residenza non ' +
        'dura almeno quattro anni; docenti e ricercatori rientrati escludono il 90% degli ' +
        'emolumenti per sei periodi d’imposta, estesi fino a tredici con figli o con ' +
        'l’acquisto dell’abitazione (art. 44, cc. 3 e 3-ter); i frontalieri — chi da ' +
        'residente lavora oltre confine in zona di frontiera «in via continuativa e come ' +
        'oggetto esclusivo del rapporto» — contano quel reddito solo oltre una franchigia ' +
        'di 10.000 €. Il c. 175 reca ancora «6.700 euro»: gli aumenti lo fissano ' +
        'dall’esterno senza riscriverlo — da ultimo l’art. 4 della L. 83/2023, dal 2024 — ' +
        'e chi legge il comma da solo esce con il numero sbagliato. ' +
        'Non sono però solo sconti: l’art. 1 c. 9 della L. 207/2024 — letto per il registro ' +
        'delle fonti — fa RIENTRARE la quota esente di impatriati e ricercatori nel reddito ' +
        'che decide percentuale e soglie del taglio del cuneo, quindi per chi ne gode le ' +
        'soglie della pagina si spostano due volte. Condizioni personali che una RAL non ' +
        'descrive: fuori perimetro, e per chi vi rientra ogni numero della pagina cambia.',
    },
    {
    ...
    },
    {
      ...
      norma:
        'Artt. 20, 23 e 29 del D.Lgs. 148/2015, letti in originale; circ. INPS 176/2016 ' +
        '§6.1 per il riparto del contributo FIS; contrattazione collettiva; art. 51 c. 2 ' +
        'lett. h) TUIR per le trattenute deducibili',
      motivo:
        'Il modello trattiene il solo 9,19% IVS più l’eventuale 1% aggiuntivo, che è quanto ' +
        'grava sul dipendente del settore privato non agricolo per la PREVIDENZA ' +
        'obbligatoria. L’integrazione salariale, però, è per legge in parte a carico del ' +
        'lavoratore: il contributo ordinario CIGS vale lo 0,90% dell’imponibile, «di cui lo ' +
        '0,30 per cento è a carico del lavoratore» (art. 23 cc. 1 e 1-bis), e dal 2022 la ' +
        'riforma degli ammortizzatori estende la CIGS ai datori sopra i quindici dipendenti ' +
        'non coperti da un fondo bilaterale, in ogni settore (art. 20 c. 3-bis): ' +
        'l’impiegato di una media impresa milanese versa quindi il 9,49%, non il 9,19%. ' +
        'Anche nel FIS — 0,50% fino a cinque dipendenti, 0,80% oltre (art. 29 c. 8) — un ' +
        'terzo del contributo ordinario è dei lavoratori: «due terzi a carico del datore di ' +
        'lavoro e un terzo a carico del lavoratore», scrive la circolare. A queste ' +
        'trattenute di legge si sommano quelle da CCNL — quote ai fondi sanitari ' +
        'integrativi, contributi associativi o sindacali — che riducono il netto e in parte ' +
        'l’imponibile. Dipendono da settore, dimensione e contratto del datore, che una RAL ' +
        'non dichiara.',
    },
    {
