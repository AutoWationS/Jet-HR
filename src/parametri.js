...
export const FONTI = {
  ...
  contributi: {
    ...
    dettaglio:
      ...
      'base già limitata al massimale, come fa il motore. L’art. 3-ter esiste solo per effetto ' +
      'della legge di conversione, quindi va citato insieme a essa.',
    prassi:
...
export const PARAMETRI_2026 = {
  ...
  fuoriPerimetro: [
    ...
    {
      voce: 'Mensilizzazione dell’aliquota aggiuntiva dell’1%',
      norma: 'Art. 3-ter D.L. 384/1992; INPS circ. n. 6 del 30/01/2026, che ne detta il criterio',
      motivo:
        'La circolare prescrive il criterio della mensilizzazione: l’1% si calcola mese per ' +
        'mese sulla quota eccedente 4.685,00 € mensili, non a fine anno sulla quota eccedente ' +
        '56.224,00 € annui. Il modello lavora a saldo d’anno e non conosce la distribuzione ' +
        'delle retribuzioni nei mesi, quindi applica il criterio annuo. Su dodici mensilità la ' +
        'differenza è di pochi centesimi; con tredicesima diventa sistematica, perché il doppio ' +
        'pagamento di dicembre supera da solo il tetto mensile: su una RAL di 56.000 € il ' +
        'modello calcola zero mentre la mensilizzazione produce circa 39 € di contributo ' +
        'aggiuntivo. È la simmetria opposta dell’ipotesi che le mensilità non cambino il netto ' +
        'annuo: qui la distribuzione conta davvero.',
    },
    {
