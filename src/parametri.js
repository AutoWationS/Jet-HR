...
export const FONTI = {
  irpef: {
    ...
    verifica: 'VERIFICATO sul testo vigente del D.P.R. 917/1986: l’art. 11 c. 1 riporta ' +
      '“a) fino a 28.000 euro, 23 per cento; b) oltre 28.000 euro e fino a 50.000 euro, ' +
      '33 per cento; c) oltre 50.000 euro, 43 per cento”. Le tre aliquote e le due soglie ' +
      'implementate coincidono con il testo applicabile all’anno d’imposta modellato',
  ...
  imposta: {
    livello: 1,
    statoVerifica: 'atto-letto',
    verifica: 'VERIFICATO sul testo vigente: l’art. 11 c. 3 dispone che l’imposta netta si determina ' +
      'operando sull’imposta lorda, “fino alla concorrenza del suo ammontare”, le detrazioni ' +
      'degli artt. 12, 13, 15, 16 e 16-bis. Il numero del comma è quello citato dal registro',
  ...
  detrazioneLavoro: {
    livello: 1,
    statoVerifica: 'atto-letto',
    verifica: 'VERIFICATO sul testo vigente del D.P.R. 917/1986. L’art. 13 c. 1 lett. a) contiene i ' +
      ...
      'superiore a 25.000 euro ma non a 35.000 euro”, confermando importo, fascia e collocazione. ' +
      'Il c. 1-bis risulta “COMMA ABROGATO DAL D.L. 5 FEBBRAIO 2020, N. 3”, che è esattamente ' +
      'quanto il registro afferma',
  ...
  arrotondamentoRapporti: {
    livello: 1,
    statoVerifica: 'atto-letto',
    verifica: 'VERIFICATO sul testo vigente: l’art. 13 c. 6 dispone che “se il risultato dei rapporti ' +
      'indicati nei commi 1, 3, 4 e 5 è maggiore di zero, lo stesso si assume nelle prime ' +
      'quattro cifre decimali”. Resta il margine interpretativo su “si assume”: il motore ' +
      'tronca, che è la prassi dei software di paghe',
  ...
  nonConcorrenzaContributi: {
    livello: 1,
    statoVerifica: 'atto-letto',
    verifica: 'VERIFICATO sul testo vigente: l’art. 51 c. 2 lett. a) dispone che “non concorrono a ' +
      'formare il reddito: a) i contributi previdenziali e assistenziali versati dal datore di ' +
      'lavoro o dal lavoratore in ottemperanza a disposizioni di legge”. Chiude la catena con ' +
      'cui il modello sostiene che la somma esente del cuneo si calcola sull’imponibile e non ' +
      'sulla RAL (metodologia §3.4), e conferma il termine esatto: non concorrenza, non deduzione',
    dove: 'D.P.R. 917/1986 (TUIR), testo vigente 2026 — art. 49',
    canale: 'normattiva',
    lacuna: 'l’art. 49, che definisce il reddito di lavoro dipendente, è stato letto nella versione ' +
      'del testo unico riordinato e non su quella vigente',
  ...
  redditoComplessivo: {
    livello: 1,
    statoVerifica: 'atto-letto',
    verifica: 'VERIFICATO sul testo vigente per la regola che incide sul calcolo: l’art. 13 c. 6-bis ' +
      'dispone che “ai fini del presente articolo il reddito complessivo è assunto al netto del ' +
      'reddito dell’unità immobiliare adibita ad abitazione principale”. Il rinvio alla ' +
      'circolare 22/E è citato testualmente dalla 4/E/2025 a pag. 6; semplificazione dichiarata ' +
      'in metodologia §5.1',
    dove: 'D.P.R. 917/1986 (TUIR), testo vigente 2026 — art. 8',
    canale: 'normattiva',
    lacuna: 'l’art. 8, che definisce il reddito complessivo, non è stato aperto: è stato letto il ' +
      'solo art. 13 c. 6-bis',
