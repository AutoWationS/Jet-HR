...
export const FONTI = {
  ...
  contributi: {
    ...
    verifica:
      'PARZIALE. La CITAZIONE è verificata sull’elenco ufficiale delle circolari INPS: numero, ' +
      'data e oggetto della n. 6 del 30/01/2026 corrispondono, ed è la circolare annuale ' +
      'competente per questi valori. Gli IMPORTI 56.224 € e 122.295 € restano riscontrati su ' +
      'fonti convergenti che la citano: il testo non è stato letto. L’aliquota IVS del 9,19% è ' +
      'un’aliquota di computo del Fondo, non fissata da una singola norma né contenuta in ' +
      'questa circolare, e va cercata nelle circolari INPS sulle aliquote contributive di ' +
      'settore. Sono i due valori del modello che cambiano ogni anno per certo: da riverificare ' +
      'a ogni circolare annuale',
  },
