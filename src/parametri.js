...
export const FONTI = {
  ...
  ragguaglioGiorni: {
    ...
    dove: 'Circolare Agenzia delle Entrate n. 15/E del 16/03/2007, sui giorni che danno diritto alla detrazione',
    canale: 'def',
    lacuna:
      'la citazione precedente alla circolare 326/E del 1997 è stata RITIRATA: la ricerca ' +
      'della stringa “365” nel testo su def.finanze.it non dà alcun risultato. Il ' +
      'riferimento corrente alla circolare 15/E del 2007 viene da fonti secondarie e non ' +
      'è stato letto in originale',
    etichetta: 'Come si contano i giorni di lavoro nell’anno',
    norma:
      'Convenzione di prassi sul ragguaglio al periodo di lavoro; riferimento indicato ' +
      'dalle fonti secondarie: circolare Agenzia delle Entrate n. 15/E del 16/03/2007',
    dettaglio:
    ...
    verifica:
      'NON VERIFICATA, e con una citazione in meno rispetto a prima. Il registro indicava ' +
      'la circolare 326/E del 23/12/1997 par. 3; cercando “365” in quel testo su ' +
      'def.finanze.it non compare nulla, quindi la citazione è stata ritirata invece di ' +
      'essere lasciata a fare da garanzia. È il terzo errore di citazione del progetto, ' +
      'dopo l’art. 13 c. 1-bis e l’art. 14 c. 8 del D.Lgs. 23/2011, e come i primi due ' +
      'non tocca un numero: la convenzione dei 365 giorni resta quella applicata da ' +
      'tutti i software di paghe, e sul caso modellato — anno intero — il ragguaglio ' +
      'vale 365/365. Serve a chi simula un rapporto parziale',
  },
};
