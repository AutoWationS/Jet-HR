...
export const FONTI = {
  ...
  addizionaleComunale: {
    ...
    norma:
      ...
      'c. 4 per la base imponibile e la condizione di debenza; per Milano, Deliberazione del ' +
      'Consiglio Comunale n. 36 del 21/10/2013 (aliquota unica 0,80%). Codice ente F205',
    dettaglio:
    ...
    verifica:
      'VERIFICATO sulla pagina istituzionale del Comune di Milano: aliquota 0,80%, esenzione ' +
      'fino a 23.000 € inclusi, delibera di Consiglio Comunale n. 36 del 21/10/2013, e la ' +
      'natura di soglia e non di franchigia dichiarata a parole. Resta una cautela: la pagina ' +
      'non è datata e cita la delibera solo per l’aliquota, non per la soglia; il valore va ' +
      'riconfermato sulla delibera di bilancio dell’anno prima di qualunque uso non ' +
      'dimostrativo. Nota terminologica: la pagina usa “reddito imponibile” nell’enunciato ' +
      'dell’esenzione e “reddito complessivo” nella relativa FAQ; nel modello le due grandezze ' +
      'coincidono per semplificazione dichiarata',
  },
...
export const PARAMETRI_2026 = {
  ...
  fuoriPerimetro: [
    ...
    },
    {
      ...
      motivo:
        'In busta paga non si versano per competenza. Per la comunale di Milano: acconto del ' +
        '30% trattenuto dal sostituto d’imposta in un massimo di 9 rate a partire da marzo, ' +
        'saldo determinato in sede di conguaglio e trattenuto in un massimo di 11 rate dal mese ' +
        'successivo; in caso di cessazione del rapporto in corso d’anno, trattenuta in unica ' +
        'soluzione. Il modello calcola per competenza sull’anno in corso: su una retribuzione ' +
